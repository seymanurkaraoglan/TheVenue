    ...
    public partial class Product : System.Web.UI.Page
    {
        ...
        protected void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (fuProductImage.HasFile)
            {
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Lütfen .jpg,.jpeg veya .png uzantılı bir fotoğraf seçiniz!\"";
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    con.Open();
                    cmd.ExecuteNonQuery();
                    actionName = productId == 0 ? "eklendi" : "güncellendi";
                    lblMsg.Visible = true;
                    lblMsg.Text = "Ürün başarıyla " + actionName;
        ...
        protected void rProduct_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "delete")
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    lblMsg.Visible = true;
                    lblMsg.Text = "Kategori başarıyla güncellendi!";
        ...
        protected void rProduct_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if(Convert.ToInt32(lblQuantity.Text) <= 5)
                {
                    ...
                    lblQuantity.ToolTip = "Ürün stokta bulunmuyor!";
                }
            }
        }
    }
