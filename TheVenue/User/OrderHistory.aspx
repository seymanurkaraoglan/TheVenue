<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="OrderHistory.aspx.cs" Inherits="TheVenue.User.OrderHistory" %>
                                                    ...
                                                    <div class="container">
                                                        <div class="row pt-1 pb-1" style="background-color: lightgray; font-size: 15px; color: #1D190A">
                                                            <div class="col-4">
                                                                ...
                                                                Ödeme Modu: <%# Eval("PaymentMode").ToString() == "cod" ? "Cash on Delivery" : Eval("PaymentMode").ToString().ToUpper() %>
                                                            </div>
                                                            <div class="col-6">
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblPrice" runat="server" Text='<%# string.IsNullOrEmpty(Eval("Price").ToString()) ? "" : "" + Eval("Price") %>'></asp:Label>TL
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblTotalPrice" runat="server" Text='<%# Eval("TotalPrice") %>'></asp:Label>TL
                                                                    </td>
                                                                    <td>
