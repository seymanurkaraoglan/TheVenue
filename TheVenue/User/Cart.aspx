<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="TheVenue.User.Cart" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove"
                                CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Bu ürünü sepetten silmek istediğine emin misin?');"><i class="fa fa-close"></i></asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    ...
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info" style="background-color:#774936;border-color:#774936;color:white"><i class="fa fa-arrow-circle-left mr-2"></i> Alışverişe devam et</a>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbUpdateCart" runat="server" CommandName="updateCart" CssClass="btn btn-warning" style="background-color:#deab90;border-color:#deab90;color:white">
                                <i class="fa fa-refresh mr-2"> Sepeti Güncelle</i>
                            </asp:LinkButton>
                        </td>
                        <td>
                            <asp:LinkButton ID="lbCheckout" runat="server" CommandName="checkout" CssClass="btn btn-success" style="background-color:#b07d62;border-color:#b07d62;color:white">
                                <i class="fa fa-arrow-circle-right mr-2"> Öde</i>
                            </asp:LinkButton>
                        </td>
                    </tr>
                        </tbody>
