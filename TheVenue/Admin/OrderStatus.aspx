<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="TheVenue.Admin.OrderStatus" %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlOrderStatus" runat="server" CssClass="form-control">
                                                            ...
                                                            <asp:ListItem>Kuyrukta</asp:ListItem>
                                                            <asp:ListItem>Kargoda</asp:ListItem>
                                                            <asp:ListItem>Teslim Edildi</asp:ListItem>
                                                        </asp:DropDownList>
                                                        <asp:RequiredFieldValidator ID="rfvDddlOrderStatus" runat="server" ForeColor="Red" ControlToValidate="ddlOrderStatus"
                                                            ErrorMessage="Sipariş durumu zorunludur" SetFocusOnError="true" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
